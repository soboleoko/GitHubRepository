...
import com.example.githubrepository.configuration.GitHubRepositoryClientConfiguration;
import com.example.githubrepository.model.GitHubRepositoryInfoDTO;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(value = "apigithub", url = "https://api.github.com", configuration = GitHubRepositoryClientConfiguration.class)
